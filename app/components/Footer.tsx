...
/**
 * Footer component with dark black background matching the design
 */
    ...
    <footer className="bg-[#1a1a1a] text-white mt-auto">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          ...
          <div>
            ...
            <p className="text-sm text-gray-400">
              Authentic wood-fired pizzas with passion and local ingredients. Welcome to the neighborhood.
            </p>
          </div>
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a
                href="#"
                className="w-10 h-10 rounded-full bg-gray-800 hover:bg-[#8B0000] flex items-center justify-center transition-colors"
        ...
        <div className="border-t border-gray-800 pt-8 flex flex-col sm:flex-row justify-between items-center text-sm text-gray-400">
          <p>&copy; 2019 Stonefire. All rights reserved.</p>
